...
## GetProducts
You can execute the `GetProducts` Query using the following Query injector, which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts):

```javascript
injectGetProducts(options?: GetProductsOptions, injector?: Injector): CreateDataConnectQueryResult<GetProductsData, undefined>;
```

### Variables
The `GetProducts` Query has no variables.
### Return Type
Recall that calling the `GetProducts` Query injector returns a `CreateDataConnectQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.
...
To access the data returned by a Query, use the `CreateDataConnectQueryResult.data()` function. The data for the `GetProducts` Query is of type `GetProductsData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `GetProducts`'s Query injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectGetProducts, GetProductsOptions } from '@dataconnect/generated/angular'
...
export class MyComponent {
  ...
  query = injectGetProducts();

  // You can also pass in an options function (not object) of type `GetProductsOptions` to the Query injector function.
  options: GetProductsOptions = () => {
    return {
      staleTime: 5 * 1000
    };
  };
  query = injectGetProducts(this.options);
}
```

## GetCartItems
You can execute the `GetCartItems` Query using the following Query injector, which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts):

```javascript
injectGetCartItems(options?: GetCartItemsOptions, injector?: Injector): CreateDataConnectQueryResult<GetCartItemsData, undefined>;
```

### Variables
The `GetCartItems` Query has no variables.
### Return Type
Recall that calling the `GetCartItems` Query injector returns a `CreateDataConnectQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `CreateDataConnectQueryResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectQueryResult.isPending()`, `CreateDataConnectQueryResult.isSuccess()`, and `CreateDataConnectQueryResult.isError()` functions.

To access the data returned by a Query, use the `CreateDataConnectQueryResult.data()` function. The data for the `GetCartItems` Query is of type `GetCartItemsData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `GetCartItems`'s Query injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectGetCartItems, GetCartItemsOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  // Since the execution of the query is eager, you don't have to call `execute` to "execute" the Query.
  // Call the Query injector function to get a `CreateDataConnectQueryResult` object which holds the state of your Query.
  query = injectGetCartItems();

  // You can also pass in an options function (not object) of type `GetCartItemsOptions` to the Query injector function.
  options: GetCartItemsOptions = () => {
    return {
      staleTime: 5 * 1000
    };
  };
  query = injectGetCartItems(this.options);
}
```
...
## AddProductToCart
You can execute the `AddProductToCart` Mutation using the `CreateDataConnectMutationResult` object returned by the following Mutation injector (which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts)):
```javascript
injectAddProductToCart(options?: AddProductToCartOptions, injector?: Injector): CreateDataConnectMutationResult<AddProductToCartData, AddProductToCartVariables, AddProductToCartVariables>;
```
...
```
### Return Type
Recall that calling the `AddProductToCart` Mutation injector returns a `CreateDataConnectMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.
...
To access the data returned by a Mutation, use the `CreateDataConnectMutationResult.data()` function. The data for the `AddProductToCart` Mutation is of type `AddProductToCartData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `AddProductToCart`'s Mutation injector

```javascript
... // other imports
import { connectorConfig, AddProductToCartVariables } from '@dataconnect/generated';
import { injectAddProductToCart, AddProductToCartOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  ...
  mutation = injectAddProductToCart();

  // You can also pass in a `AddProductToCartOptions` function (not object) to the Mutation injector function.
  options: AddProductToCartOptions = () => {
    return {
      onSuccess: () => { console.log('Mutation succeeded!'); }
    };
  };
  mutation = injectAddProductToCart(this.options);
  ...
  executeMutation() {
    ...
    this.mutation.mutate(addProductToCartVars);
    ...
    this.mutation.mutateAsync(addProductToCartVars);

    // You can also pass in a `AddProductToCartOptions` object (not function) to `CreateDataConnectMutationResult.mutate()`.
    this.mutation.mutate(addProductToCartVars, this.options());
  }
}
```

## PlaceOrder
You can execute the `PlaceOrder` Mutation using the `CreateDataConnectMutationResult` object returned by the following Mutation injector (which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts)):
```javascript
injectPlaceOrder(options?: PlaceOrderOptions, injector?: Injector): CreateDataConnectMutationResult<PlaceOrderData, undefined, >;
```

### Variables
The `PlaceOrder` Mutation has no variables.
### Return Type
Recall that calling the `PlaceOrder` Mutation injector returns a `CreateDataConnectMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `CreateDataConnectMutationResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectMutationResult.isPending()`, `CreateDataConnectMutationResult.isSuccess()`, and `CreateDataConnectMutationResult.isError()` functions.

To execute the Mutation, call `CreateDataConnectMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation. 

To access the data returned by a Mutation, use the `CreateDataConnectMutationResult.data()` function. The data for the `PlaceOrder` Mutation is of type `PlaceOrderData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `PlaceOrder`'s Mutation injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectPlaceOrder, PlaceOrderOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  // Call the Mutation injector function to get a `CreateDataConnectMutationResult` object which holds the state of your Mutation.
  mutation = injectPlaceOrder();

  // You can also pass in a `PlaceOrderOptions` function (not object) to the Mutation injector function.
  options: PlaceOrderOptions = () => {
    return {
      onSuccess: () => { console.log('Mutation succeeded!'); }
    };
  };
  mutation = injectPlaceOrder(this.options);
  ...
  executeMutation() {
    ...
    // You can also pass in a `PlaceOrderOptions` object (not function) to `CreateDataConnectMutationResult.mutate()`.
